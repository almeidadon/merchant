...
class ProcessCollect extends CI_Controller
{
...
//        $this->load->library('wallet_shmart');
    ...
    function transactions() //Function validates the incoming requests
    {
        ...
        if ($this->input->server('REQUEST_METHOD') == 'GET' || $this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            $data['app_used']            = 'COLLECT'; //Hard code in each API
    ...
    */
    ...
    function render_payment_page($customer_details)
    {
		...
		if ($detect->isMobile() || $detect->isTablet()) {
			// $this->load->view('mobile_payment_page/header_mobile');
			// $this->load->view('mobile_payment_page/body_mobile',$payment_page_data);
			// $this->load->view('mobile_payment_page/footer_mobile');
