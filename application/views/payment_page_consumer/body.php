    ...
    <!-- preloader -->
        ...
        <div id="top-navbar" class="navbar navbar-static-top navbar-default navbar-inverse add-shadow" role="navigation">
            <div class="navbar-header text-center">  
				...
				<a href="#"> <img src="<?php echo base_url();?>/assets_todo/images/shmart_wallet.png" alt="logo" class="img-responsive"></a>
				</div>
                <!-- / logo -->
            </div>
          ...
          <div id="page-content-wrapper" class=" animated-med-delay fadeInRight">
                                                   ...
                                                   <div class="carousel slide carousel-fade" id="carousel_fade">
                                                        <div class="carousel-inner">       
                                                              <div class="item active">
																...
																<?php } ?>	
																	<div class="col-lg-4 col-sm-6 col-xs-6 pull-right">
																	<h5 class="text-right">Merchant reference ID : <?php echo $merchant_refID; ?></h5>
																	</div>
															  ...
															  <?php if($customer_details['customer_data'] != '0') { ?>
																	...
																	<?php if($wallet_amount>'0' || $consumer_fund == '1' ) { ?> <!--	<span class="check pull-left"><div class="ez-checkbox"><div class="ez-checkbox"><div class="ez-checkbox"><input type="checkbox" id="use_wallet" <?php if($wallet_amount) { ?> checked="checked" <?php } ?> class="checked ez-hide"></div></div></div></span>--> <?php } ?>
																		...
																		<div class="col-lg-7 col-sm-5 col-xs-6" style="padding-top:25px;">																		
                                                                        <h3>
																		Your current balance is Rs <?php echo $wallet_amount ;?> .
																<!--	<?php if ($whitelabel) { ?>
																	...
																	<?php }?>
																		...
																		<input type="hidden" name="use_wallet" value="<?php if($wallet_amount >= $total_amount AND $wallet_amount> "0" ) { ?>1<?php } else { ?>0<?php } ?>" class="use_wallet_field"/>
					...
					<!--Payment optins-->
							<div class="panel panel-body-only panel-white-solid content">
								...
								<div class="col-md-12">
								<div class="col-md-7">
								<h2 style="padding-bottom:15px;">Select your payment option</h2>
								</div>
								<div class="col-md-5">
										...
										<div class="col-lg-6 no-padding">
											<div class="col-lg-12">
												...
												<div class="col-sm-12 saved_card_cvv form-group" id="<?php echo $saved_cards['user_card_unique_token']; ?>" style="display:none">
													...
													<input type="hidden" name="use_wallet" value="0" class="use_wallet_field"/>
						...
						<!--/ Payment optins-->
							...
							<div class="col-sm-12 text-center no-padding">
													<label for="exampleInputEmail1"><small></br>Shmart! Wallet offers you membership to the semi-closed loop prepaid instrument issued by RBL Bank</small></label></br>
													<label for="exampleInputEmail1"><small><i>2015 - All rights are reserved with TranServ Private Limited</i></small></label><br />
													<label for="exampleInputEmail1"><small><a target="_blank" href="http://shmart.in/tc.html" style="color:#3651A2">Terms and Conditions</a></small></label></br>
