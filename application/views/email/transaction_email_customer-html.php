...
<body>
<?php	if($status == '0')	{ ?>
<p>Dear <?php echo $name_on_card; ?>,<br /><br />
Thank You for using Shmart! We offer you a secure and convenient way of making online payments. Your payment receipt is attached below. <br /><br />
Total amount paid : Rs. <?php echo $total_amount; ?><br />
Merchant Name : <?php echo $merchant_website; ?><br />
Transaction reference ID: <?php echo $merchant_refID; ?><br />
Payment Made from : <?php if($transaction_mode == 'PG') { echo 'Payment Gateway' ;} else if($transaction_mode == 'W') {echo 'Wallet' ;} else { echo 'Wallet + Payment Gateway' ; } ?> <br /><br />
<i>Note: This is an electronically generated receipt and does not require a signature.</i><br /><br />
If you have not initiated this transaction or have any queries please contact us at 022 &ndash; 6730 4948 or WeCare@Shmart.in </p>

<p>Shmart! Care Team<br />
022-67304948 <br />
WeCare@Shmart.in</p>
<?php } else { ?>

<p>Dear <?php echo $name_on_card; ?>,<br /><br />
Your Payment to <?php echo $merchant_website; ?>  has failed! <br /><br />
Your request for making an online payments has not been approved.<br />
Merchant Name : <?php echo $merchant_website; ?><br />
Transaction reference ID: <?php echo $merchant_refID; ?><br />
Payment Made from : <?php if($transaction_mode == 'PG') { echo 'Payment Gateway' ;} else if($transaction_mode == 'W') {echo 'Wallet' ;} else { echo 'Wallet + Payment Gateway' ; } ?> <br /><br />
<i>Note: This is an electronically generated receipt and does not require a signature.</i><br />
If you have not initiated this transaction or have any queries please contact us at 022 &ndash; 6730 4948 or WeCare@Shmart.in </p>
...
<div style="width:620px; margin:auto" id="main">
  ...
  <tr>
    ...
    <td><span style="margin:0px; font-family: 'Trebuchet MS', helvetica, Arial, sans; font-size:16px; color:#535252; font-weight:normal; line-height:16px;">Use your mobile number as <strong>userID</strong></span></td>
  </tr>
  <tr>
    ...
    <td><span style="margin:0px; font-family: 'Trebuchet MS', helvetica, Arial, sans; font-size:16px; color:#535252; font-weight:normal; line-height:16px;">Use this password to login - &lt;<strong>xxxxxxx</strong>&gt;</span></td>
  </tr>
</table>
