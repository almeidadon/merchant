	...
	<form action="<?php echo base_url(); ?>iframe/pay/process" method="post" id="card-form">
		...
		<div class="col-sm-12 form-group padding-bottom">
			...
			<div class="col-md-6 col-xs-6 padding-bottom">
				<select id="cardExpiryMonth" name="cardExpiryMonth" class="form-control  mrs mbm">
				...
				<div class="col-md-6 col-xs-6 padding-bottom">
				<select id="cardExpiryYear" name="cardExpiryYear" class="form-control mrs mbm">
			...
			<div class="col-md-4 col-xs-4 padding-bottom">
				<input type="text" name="cvv" id="cvv" value="" placeholder="CVV" class="form-control" />				
			</div>
		...
		<div class="col-md-12 col-xs-12">
			<input type="submit" class="btn btn-sm btn-primary sub-button" onclick="encryptCCnumber()"  value="MAKE PAYMENT" />
		</div>
	</form>