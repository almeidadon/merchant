...
if(isset($_POST['submit']))	
{
 ...
 $data['input_string'] = $merchant_id.'|'.$apikey.'|'.$ip_address.'|'.$merchant_refID.'|'.$currency_code.'|'.$amount.'|'.$checksum_method.'|'.$authorize_user ;
	...
	//echo "</br> checksum is=".$checksum;
	 ...
	 echo '<html>
			   <body>
			   <form id="pay" action="http://shmarttest.in/api/test_app/v1/transactions" method="POST" >
...
<input type="text" name="apikey" value='281f4a32bc92e00d49add4f73a7ba5be' style="width:230px;">
</p>
<p>
<label for='mobile'>Secret Key: </label><br>
<input type="text" name="secretkey" value='ccc9d34fd6925728a0d3d8e8379f3944' style="width:230px;">
</p>
<p>
